...
DATABASES = {
    'default': {
        ...
        'NAME': 'mystore.data',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'rosl9qz9g3+e8$f1f5*^zje&amp;g183)&amp;(34tac6!&amp;o7w=@h!j7xc'
...
TEMPLATE_DIRS = (
    ...
    os.path.join(os.path.dirname(__file__), '..', 'feincms/templates').replace('\\','/'),
)
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    'utils.context_processors.mystore'
)
